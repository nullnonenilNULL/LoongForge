<p align="right"><sub><a href="./README_v2.md">English</a> | <b>简体中文</b></sub></p>
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="#embodied"><b>🤖 具身智能</b></a>
  &nbsp;·&nbsp;
  <a href="#contact"><b>💬 联系我们</b></a>
</p>

<p align="center">
  <img src="./docs/assets/images/demo/intro-placeholder.svg" alt="LoongForge 项目介绍视频——即将上线" width="800">
</p>
...
<p align="center"><sub>例：DreamZero 8 卡训练，吞吐为官方基线的 <b>4.38×</b>，loss 曲线对齐。</sub></p>
...
多数训练框架止步于训练环节。**LoongForge-Embodied** 是覆盖数据、模型开发、训练、评测到部署全链路的 torch-native 子系统，让具身模型更快地从想法走向真机。[[使用文档]](https://loongforge.readthedocs.io/zh-cn/latest/embodied_tutorial/overview.html) · [[博客]](https://baidu-baige.github.io/LoongForge/blog/2026-07-announcing-loongforge-embodied.html)

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-01.svg" alt="动画占位：Ego 数据管线" width="800">
</p>

**首先是数据。**针对具身智能高质量第一视角数据不足的问题，我们推出 **Ego 数据管线**——将第一视角视频自动转化为具身训练数据，兼容 16 种机械臂本体，满足具身模型对大规模、高保真、多模态数据的需求。

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-02.svg" alt="动画占位：模板化模型开发" width="800">
</p>

**有了数据，还要降低模型创新门槛。**通过模板化、组件化开发，支持 VLM、VLA、世界模型等不同架构快速组合与二次开发，将模型开发周期缩短数周。

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-03.svg" alt="动画占位：训练加速" width="800">
</p>

**模型搭建完成后，就进入训练。**针对 11 个主流具身模型，通过训存协同与 AI Infra 工程优化，训练效率提升 **1.79×–4.38×**。[[各模型训练配方]](https://loongforge.readthedocs.io/zh-cn/latest/embodied_tutorial/overview.html)

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-04.svg" alt="动画占位：统一仿真评估" width="800">
</p>

**训练完成并不意味着可以直接进入真实世界。**统一评测协议，一套配置覆盖 LIBERO / RoboTwin / SimplerEnv 等主流 benchmark；日志落盘、可回放、可复现；动作缓存与断点续跑，让评测又快又稳。[[评测文档]](https://loongforge.readthedocs.io/zh-cn/latest/embodied_tutorial/eval_docs/eval_protocol.html)

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-05.svg" alt="动画占位：推理部署" width="800">
</p>

**最终，模型的价值要在真机上兑现。**通过低精度推理与软硬协同优化，兼容多类机器人本体及芯片，持续提升推理速度、降低资源占用。

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-06.svg" alt="动画占位：全链路点亮" width="800">
</p>

**基于 LoongForge-Embodied 训练框架**，让具身模型迭代得更快、部署得更广，加速 Physical AI 从能力验证走向生产力兑现。[[发布博客]](https://baidu-baige.github.io/LoongForge/blog/2026-07-announcing-loongforge-embodied.html)
