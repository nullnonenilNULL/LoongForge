...
TRANSFORMERS_PIP_SPEC=${TRANSFORMERS_PIP_SPEC:-"transformers==4.57.1"}
...
# Runtime ModelOpt script checkout. Pin by default to the same ModelOpt commit
# used by the Kimi K2.x NVFP4 conversion scripts.
...
MODELOPT_REPO=${MODELOPT_REPO:-"${MODELOPT_REPO_BASE}/Model-Optimizer-kimi-k2.5-b02e888"}
