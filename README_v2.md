<p align="right"><sub><b>English</b> | <a href="./README_v2_zh.md">简体中文</a></sub></p>
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="#embodied"><b>🤖 Embodied</b></a>
  &nbsp;·&nbsp;
  <a href="#contact"><b>💬 Contact Us</b></a>
</p>

<p align="center">
  <img src="./docs/assets/images/demo/intro-placeholder.svg" alt="LoongForge introduction video — coming soon" width="800">
</p>
...
<p align="center"><sub>e.g. DreamZero on 8 GPUs: <b>4.38×</b> throughput vs. the official baseline, loss curves aligned.</sub></p>
...
<a id="embodied"></a>
## 🤖 Embodied: From Data to Deployment

Most training frameworks stop at the training loop. **LoongForge-Embodied** is a torch-native subsystem covering the whole loop for VLA, WAM, and world models — data, model development, training, evaluation, and deployment — so embodied models go from idea to real robots faster. [[Usage docs]](https://loongforge.readthedocs.io/en/latest/embodied_tutorial/overview.html) · [[Blog]](https://baidu-baige.github.io/LoongForge/blog/2026-07-announcing-loongforge-embodied.html)

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-01.svg" alt="Animation placeholder: the Ego data pipeline" width="800">
</p>

**It starts with data.** High-quality egocentric video is scarce in embodied AI, so we built the **Ego pipeline** — it automatically converts first-person videos into embodied training data, compatible with 16 robot-arm embodiments, meeting embodied models' needs for large-scale, high-fidelity, multi-modal data.

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-02.svg" alt="Animation placeholder: templated model development" width="800">
</p>

**With data in place, the next bottleneck is model innovation.** Template-based, component-based development supports rapid assembly and customization of VLM, VLA, and world-model architectures — shortening model development cycles by weeks.

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-03.svg" alt="Animation placeholder: training acceleration" width="800">
</p>

**Then, training.** Across 11 mainstream embodied models, co-designed training-storage scheduling and AI Infra engineering lift training efficiency by **1.79×–4.38×**. [[Quick-start recipes]](https://loongforge.readthedocs.io/en/latest/embodied_tutorial/overview.html)

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-04.svg" alt="Animation placeholder: unified simulation evaluation" width="800">
</p>

**Finishing training doesn't mean the model is ready for the real world.** A unified evaluation protocol covers LIBERO / RoboTwin / SimplerEnv and other mainstream benchmarks with a single config; logs are persisted, replayable, and reproducible; action caching and checkpoint resume keep evaluation fast and stable. [[Eval docs]](https://loongforge.readthedocs.io/en/latest/embodied_tutorial/eval_docs/eval_protocol.html)

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-05.svg" alt="Animation placeholder: inference and deployment" width="800">
</p>

**In the end, a model's value is realized on real robots.** Low-precision inference and software-hardware co-optimization, compatible with a wide range of robot embodiments and chips, deliver faster inference at lower resource cost.

<p align="center">
  <img src="./docs/assets/images/embodied/placeholder-06.svg" alt="Animation placeholder: the full loop, lit end to end" width="800">
</p>

**Built on LoongForge-Embodied, embodied models iterate faster and deploy more broadly** — accelerating Physical AI from capability validation to real productivity. [[Announcement]](https://baidu-baige.github.io/LoongForge/blog/2026-07-announcing-loongforge-embodied.html)
